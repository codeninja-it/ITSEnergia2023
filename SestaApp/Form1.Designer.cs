namespace SestaApp
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			numPeso.Location = new Point(225, 12);
			...
			numAltezza.Location = new Point(225, 57);
			numAltezza.Maximum = new decimal(new int[] { 210, 0, 0, 0 });
			numAltezza.Name = "numAltezza";
			numAltezza.Size = new Size(181, 39);
			...
			btnCalcola.Size = new Size(394, 151);
			...
			txtRisultato.Location = new Point(12, 259);
			txtRisultato.Name = "txtRisultato";
			txtRisultato.ReadOnly = true;
			txtRisultato.Size = new Size(394, 39);
			txtRisultato.TabIndex = 5;
			// 
			// prgBMI
			// 
			prgBMI.Anchor = AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			prgBMI.Location = new Point(12, 304);
			prgBMI.Maximum = 60;
			prgBMI.Name = "prgBMI";
			prgBMI.Size = new Size(394, 46);
			prgBMI.TabIndex = 6;
			prgBMI.Value = 50;
			// 
			// Form1
